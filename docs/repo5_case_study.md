...
This project is strongest as a portfolio example of deterministic decision-support architecture, analytics workflow design, rules-based orchestration, evidence traceability, and local application productization. It demonstrates judgment about what not to build: no unnecessary cloud deployment, no autonomous agents, no forecasting claims, and no advice framing.

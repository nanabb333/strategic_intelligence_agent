...
- **Confidence:** Medium
- **Source status:** source pending; educational summary
- **Retrieval reason:** general outcome relevance

## Strategic Lessons

### Supply chain diversification frequently appears after export-control or disruption shocks.

- **Supporting cases:** CHIPS and Science Act (2022), Inflation Reduction Act Clean Energy Incentives (2022), Strategic Battery Supply Policy (2021), Huawei Entity List (2019)
- **Confidence:** High
...
- **Supporting cases:** Inflation Reduction Act Clean Energy Incentives (2022), GDPR Implementation (2018), Huawei Entity List (2019)
- **Confidence:** High
...
- **Supporting cases:** CHIPS and Science Act (2022), Inflation Reduction Act Clean Energy Incentives (2022), Strategic Battery Supply Policy (2021), Huawei Entity List (2019)
- **Confidence:** High
- **Rationale:** Matched 4 retrieved outcome case(s) with rule keywords: incentive, eligibility, domestic, subsidy.

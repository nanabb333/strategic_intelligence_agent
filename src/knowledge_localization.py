...
KNOWLEDGE_TERMS = {
    "zh-CN": {
        ...
        "Legislative / Regulatory": "立法 / 监管",
        "Business Strategy": "商业战略",
        "Direct Answer": "直接回答",
        "Historical Patterns": "历史规律",
        "Historical Outcome Distribution": "历史结果分布",
        "Expectation vs Reality": "预期与现实差距",
        "Market Expectations vs Outcomes": "市场预期与结果",
        "Strategic Watchlist": "战略观察清单",
        "Role-Based Monitoring": "按角色观察重点",
        "Important Limitations": "限制说明",
    },
    "zh-TW": {
        ...
        "Economics": "經濟",
        "Political Economy": "政治經濟",
        "International Relations": "國際關係",
        "Legislative / Regulatory": "立法 / 監管",
        "Business Strategy": "商業策略",
        "Direct Answer": "直接回答",
        "Historical Patterns": "歷史規律",
        "Historical Outcome Distribution": "歷史結果分布",
        "Expectation vs Reality": "預期與現實差距",
        "Market Expectations vs Outcomes": "市場預期與結果",
        "Strategic Watchlist": "策略觀察清單",
        "Role-Based Monitoring": "按角色觀察重點",
        "Important Limitations": "限制說明",
    },
}

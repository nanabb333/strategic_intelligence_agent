...
- **Initial / mainstream expectation:** Observers often expect direct benefits from subsidies or incentives.
- **Market or user behavior:** Local dataset does not contain enough market-outcome evidence for this claim.
- **Actual observed outcome:** Public incentives reshaped capacity planning and domestic manufacturing discussions.
- **Expectation gap:** Implementation details, eligibility rules, and capacity constraints can shape who can actually use the policy.
- **Lesson:** Watch implementation guidance and execution requirements before assuming strategic value.

### Inflation Reduction Act Clean Energy Incentives (2022)

- **Initial / mainstream expectation:** Observers often expect direct benefits from subsidies or incentives.
- **Market or user behavior:** Local dataset does not contain enough market-outcome evidence for this claim.
- **Actual observed outcome:** Industrial incentives affected domestic content planning and clean-energy supply-chain strategy.
- **Expectation gap:** Implementation details, eligibility rules, and capacity constraints can shape who can actually use the policy.
- **Lesson:** Watch implementation guidance and execution requirements before assuming strategic value.

### Japan-Korea Materials Dispute (2019)

- **Initial / mainstream expectation:** Observers often expect tariff or customs effects to be the main issue.
- **Market or user behavior:** Local dataset does not contain enough market-outcome evidence for this claim.
- **Actual observed outcome:** Input-specific trade controls exposed dependence on specialized upstream suppliers.
- **Expectation gap:** The broader effect can include documentation burden, sourcing changes, and cross-border operating complexity.
- **Lesson:** Monitor implementation details and how firms adjust cross-border workflows.

### Brexit Supply Chain Uncertainty (2016)

- **Initial / mainstream expectation:** Observers often expect tariff or customs effects to be the main issue.
- **Market or user behavior:** Local dataset does not contain enough market-outcome evidence for this claim.
- **Actual observed outcome:** Customs and regulatory uncertainty complicated cross-border operating models.
- **Expectation gap:** The broader effect can include documentation burden, sourcing changes, and cross-border operating complexity.
- **Lesson:** Monitor implementation details and how firms adjust cross-border workflows.
...
- **Initial / mainstream expectation:** Observers often expect direct benefits from subsidies or incentives.
- **Market or user behavior:** Local dataset does not contain enough market-outcome evidence for this claim.
- **Actual observed outcome:** Policy support increased attention to domestic battery inputs and supply security.
- **Expectation gap:** Implementation details, eligibility rules, and capacity constraints can shape who can actually use the policy.
- **Lesson:** Watch implementation guidance and execution requirements before assuming strategic value.
...
- The Industrial Policy frame is an appropriate starting point for analysis.
- The identified mechanisms remain relevant to the decision context: Industrial Subsidy, Policy Signaling, Strategic Dependency.
...
- Evidence shows the situation no longer fits the Industrial Policy frame.
